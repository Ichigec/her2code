...
To create: `hermes cron create --name claw-daily "0 2 * * *" "Run claw orchestration cycle: full 5-phase maintenance." --deliver telegram:<YOUR_TELEGRAM_CHAT_ID>`
...
| Unused MCP server with capabilities | Tag `#research-needed` in summaries for Deep Plan Researcher |
| New tool pattern discovered | Tag `#research-needed` with description for future research cycles |

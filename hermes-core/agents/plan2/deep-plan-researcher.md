...
4. Score каждый источник (0-8: authority 0-2, recency 0-2, relevance 0-2, corroboration 0-2)
...
7. Записать `docs/research/<slug>.md`

**Обязательные секции артефакта:**

```markdown
## Research Report: <topic>

**Mode:** BALANCED
**Sub-agents used:** 5 (+ debate on RQ1)
**Sources consulted:** N
**Gate B score:** 0.X/1.0
...
### Debate Resolution (если был debate)

| RQ | Agent A (deepseek) | Agent B (kimi) | Conflict | Resolution |
|----|-------------------|----------------|----------|------------|
...
### Developer Handoff
- Что уже исследовано: [summary]
- Что не исследовано: [gaps]
- Что мешало: [blockers]

---
label: Plan4 · Tech Lead v2 · Production Manager
...
delegate_task(
  ...
  model="diffusiongemma-abliterated", provider="custom:kimi", role="leaf"
)
...
delegate_task(
  ...
  model="diffusiongemma-abliterated", provider="deepseek", role="leaf"
)
...
| **Time budget** | 120s |
| **Fallback model** | diffusiongemma-abliterated via deepseek |
...
|---------|------------------------------------------|
| L3 tasks on kimi → 2+ attempts | `target: "model_routing", change: "L3 → diffusiongemma-abliterated"` |

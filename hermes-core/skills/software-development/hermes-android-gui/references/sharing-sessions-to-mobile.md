...
When you've produced research or analysis in a Hermes session and want Pavel to read it in the Android app as a standalone dialog, inject it into `state.db` as a new session.

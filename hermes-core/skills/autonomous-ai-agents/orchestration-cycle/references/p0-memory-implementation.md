...
Pavel decided: **FTS5 + SegTreeMem is sufficient**. External plugins (Mem0, Honcho, Holographic — 500K LOC total) add complexity without clear benefit. config: `memory.provider: ''` — none active. Reranker preferred over external semantic backend.

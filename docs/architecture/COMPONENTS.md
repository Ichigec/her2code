...
| **Credentials** | `pavel` / `changeme123` (default — must change in production) |
...
| Attribute | Value |
|-----------|-------|
| **Purpose** | Custom skills extending the agent's capabilities: `pavel-environment` (hardware specifics), `hermes-distribution`, `software-development/hermes-android-client`, and 21+ others. |
